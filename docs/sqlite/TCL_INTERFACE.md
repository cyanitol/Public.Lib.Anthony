...
[2. Building And Installing The SQLite Extension for Tcl](#building_and_installing_the_sqlite_extension_for_tcl)
[2.1. How the build process works](#how_the_build_process_works)
[2.2. Additional build documentation](#additional_build_documentation)
[3. The Tcl interface to the SQLite library](#the_tcl_interface_to_the_sqlite_library)
[3.1. The eval method](#the_eval_method)
[3.2. The close method](#the_close_method)
[3.3. The transaction method](#the_transaction_method)
[3.4. The cache method](#the_cache_method)
[3.5. The complete method](#the_complete_method)
[3.6. The config method](#the_config_method)
[3.7. The copy method](#the_copy_method)
[3.8. The timeout method](#the_timeout_method)
[3.9. The busy method](#the_busy_method)
[3.10. The enable_load_extension method](#the_enable_load_extension_method)
[3.11. The exists method](#the_exists_method)
[3.12. The last_insert_rowid method](#the_last_insert_rowid_method)
[3.13. The function method](#the_function_method)
[3.14. The nullvalue method](#the_nullvalue_method)
[3.15. The onecolumn method](#the_onecolumn_method)
[3.16. The changes method](#the_changes_method)
[3.17. The total_changes method](#the_total_changes_method)
[3.18. The authorizer method](#the_authorizer_method)
[3.19. The bind_fallback method](#the_bind_fallback_method)
[3.20. The progress method](#the_progress_method)
[3.21. The collate method](#the_collate_method)
[3.22. The collation_needed method](#the_collation_needed_method)
[3.23. The commit_hook method](#the_commit_hook_method)
[3.24. The rollback_hook method](#the_rollback_hook_method)
[3.25. The status method](#the_status_method)
[3.26. The update_hook method](#the_update_hook_method)
[3.27. The preupdate method](#the_preupdate_method)
[3.28. The wal_hook method](#the_wal_hook_method)
[3.29. The incrblob method](#the_incrblob_method)
[3.30. The errorcode method](#the_errorcode_method)
[3.31. The trace method](#the_trace_method)
[3.32. The trace_v2 method](#the_trace_v2_method)
[3.33. The backup method](#the_backup_method)
[3.34. The restore method](#the_restore_method)
[3.35. The serialize method](#the_serialize_method)
[3.36. The deserialize method](#the_deserialize_method)
[3.37. The interrupt method](#the_interrupt_method)
[3.38. The version method](#the_version_method)
[3.39. The profile method](#the_profile_method)
[3.40. The unlock_notify method](#the_unlock_notify_method)
...
and the primary [test suite](testing.html) for SQLite is written in Tcl and uses
...
[canonical SQLite source tree](amalg-v-canon.html#canon) and run the makefile
...
- **tclextension** -> Build the SQLite extension but do not
move the files into the installation directory.

- **tclextension-list** ->  Show all SQLite extensions available to
the Tcl interpreter specified to ./configure or by TCLDIR.

- **tclextension-uninstall** ->  Uninstall the SQLite extension.

- **tclextension-verify** -> Verify that the installed SQLite extension
...
file name [src/tclsqlite.c](https://sqlite.org/src/file/src/tclsqlite.c).
This one file is appended to the [amalgamation](amalgamation.html) ("sqlite3.c") that
...
See the [src/tcl-extension-testing.md](https://sqlite.org/src/file/doc/tcl-extension-testing.md)
...
[**sqlite3_complete()**](c3ref/complete.html) C
function.

## 3.6. The config method

The "config" method queries or changes certain configuration settings for
the database connection using the [sqlite3_db_config()](c3ref/db_config.html) interface.
...
it is invoked.  The argument is the number of prior calls to the busy
...
[load_extension()](lang_corefunc.html#load_extension) SQL function) is turned off by default.  This is
a security precaution.  If an application wants to make use of the
[load_extension()](lang_corefunc.html#load_extension) function it must first turn the capability on using
this method.
...
and run [PRAGMA trusted_schema=OFF](pragma.html#pragma_trusted_schema) or the
"[db config trusted_schema 0](#config)" method before
invoking this method.

This method maps to the [sqlite3_enable_load_extension()](c3ref/enable_load_extension.html) C/C++
interface.
...
[PRAGMA trusted_schema=OFF](pragma.html#pragma_trusted_schema) or run the
"[db config trusted_schema 0](#config)"
...
its numeric argument into a hexadecimal encoded string:
...
top-level SQL statements.  The function will not be accessible to
...
[PRAGMA trusted_schema=OFF](pragma.html#pragma_trusted_schema).  The use of this option is discouraged
...
As of version 3.51, a `break` propagating from an SQL function will
be interpreted as an SQL NULL, as distinct from an empty string.
...
Because method names can be shortened to any unique prefix, this method
is usually written as "one" instead of its full name "onecolumn".
...
[sqlite3_stmt_status()](c3ref/stmt_status.html) C-language interface.
...
SQLITE_ERROR if some error occurs). As in [sqlite3_wal_hook()](c3ref/wal_hook.html), the results of
...
[sqlite3_blob_open()](c3ref/blob_open.html) C-language
...
to the underlying [sqlite3_stmt](c3ref/stmt.html) object.  This integer can be used
...
is the value of the underlying [sqlite3_stmt](c3ref/stmt.html) object.  The second
...
[sqlite3_stmt](c3ref/stmt.html) object pointer.
...
commands will likely return [SQLITE_CORRUPT](rescode.html#corrupt) errors.

## 3.37. The interrupt method

The "interrupt" method invokes the [sqlite3_interrupt()](c3ref/interrupt.html) interface, causing
...
The unlock_notify method is used to access the [sqlite3_unlock_notify()](c3ref/unlock_notify.html)
   interface to the SQLite core library for testing purposes.  The use of
   this method by applications is discouraged.

*This page was last updated on 2025-12-07 18:24:29Z *