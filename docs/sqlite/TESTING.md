...
The **[TH3](th3.html)** test harness is a set of proprietary tests, written in
...
The [**SQL Logic Test**](https://sqlite.org/sqllogictest)
...
The [**dbsqlfuzz**](#dbsqlfuzz) engine is a
...
implementation using the [sqlite3_config](c3ref/config.html)([SQLITE_CONFIG_MALLOC](c3ref/c_config_covering_index_scan.html#sqliteconfigmalloc),...)
...
[PRAGMA integrity_check](pragma.html#pragma_integrity_check) to make sure that the I/O error has not
...
[integrity_check](pragma.html#pragma_integrity_check) [PRAGMA](pragma.html#syntax) is used to make sure no database corruption
occurs.
...
[test/ossfuzz.c](https://sqlite.org/src/file/test/ossfuzz.c) source file
...
Rigger has found
[many such cases](https://sqlite.org/src/timeline?y=t&u=mrigger&n=all).
...
using the [SQLITE_CORRUPT](rescode.html#corrupt) return code without overflowing
...
the [sqlite3_test_control](c3ref/test_control.html)([SQLITE_TESTCTRL_ALWAYS](c3ref/c_testctrl_always.html), ...) interface that
...
[hash function](https://sqlite.org/src/artifact/55b5fb474?ln=55-62)
...
However, if SQLite is compiled with [SQLITE_MEMDEBUG](compile.html#memdebug), an alternative
...
[sqlite3_mutex_held()](c3ref/mutex_held.html) and [sqlite3_mutex_notheld()](c3ref/mutex_held.html) that detect
...
The [sqlite3_test_control](c3ref/test_control.html)([SQLITE_TESTCTRL_OPTIMIZATIONS](c3ref/c_testctrl_always.html), ...) interface
...
[Past checklists](https://sqlite.org/checklists/index.html)
