...
**Test**: `TestCTEInSubquery` (line 515, `/home/justin/Programming/Workspace/Public.Lib.Anthony/internal/driver/cte_attach_test.go`)
...
1. `/home/justin/Programming/Workspace/Public.Lib.Anthony/internal/driver/stmt_cte_coroutine.go` - `compileCTEPopulationCoroutine()`
...
**Code Locations**:
- `/home/justin/Programming/Workspace/Public.Lib.Anthony/internal/driver/stmt_cte_coroutine.go:21-60` - Coroutine compilation
- `/home/justin/Programming/Workspace/Public.Lib.Anthony/internal/driver/stmt_cte_coroutine.go:85-98` - OpResultRow conversion
- `/home/justin/Programming/Workspace/Public.Lib.Anthony/internal/driver/stmt_cte.go:76-110` - CTE materialization
...
- **Location**: `/home/justin/Programming/Workspace/Public.Lib.Anthony/internal/schema/view.go:155` and `/home/justin/Programming/Workspace/Public.Lib.Anthony/internal/schema/master.go:427`
...
- **Location**: `/home/justin/Programming/Workspace/Public.Lib.Anthony/internal/schema/master.go:269`
...
1. `/home/justin/Programming/Workspace/Public.Lib.Anthony/internal/schema/master.go`
   - Fixed `SeekRowid()` return value handling
   - Restored `parseViewSQL()` function with complete implementation

2. `/home/justin/Programming/Workspace/Public.Lib.Anthony/internal/schema/view.go`
   - Removed duplicate `parseViewSQL()` function

3. `/home/justin/Programming/Workspace/Public.Lib.Anthony/internal/driver/cte_attach_test.go`
