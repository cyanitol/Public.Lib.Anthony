...
func TestCastToNumeric(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := EvaluateCast(tt.value, "NUMERIC")
			if !compareResults(result, tt.expected) {
				t.Errorf("Expected %v, got %v", tt.expected, result)
			}
		})
...
func TestCastToReal(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := EvaluateCast(tt.value, "REAL")
			if !compareResults(result, tt.expected) {
				t.Errorf("Expected %v, got %v", tt.expected, result)
			}
		})
...
func TestCastToBlob(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := EvaluateCast(tt.value, "BLOB")
			if !compareResults(result, tt.expected) {
				t.Errorf("Expected %v, got %v", tt.expected, result)
			}
		})
...
func TestGetBinaryCompareCollSeq(t *testing.T) {
	tests := []struct {
		...
		{
			name: "Left has collate",
			left: &Expr{
				Op:      OpCollate,
				CollSeq: "NOCASE",
				Flags:   EP_Collate,
			},
			right:    &Expr{Op: OpColumn},
			expected: "NOCASE",
		},
		{
			name: "Right has collate",
			left: &Expr{Op: OpColumn},
			right: &Expr{
				Op:      OpCollate,
				CollSeq: "RTRIM",
				Flags:   EP_Collate,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			coll := GetBinaryCompareCollSeq(tt.left, tt.right)
			if coll.Name != tt.expected {
				t.Errorf("Expected %s, got %s", tt.expected, coll.Name)
			}
		})
	}
}
