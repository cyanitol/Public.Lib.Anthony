...
schema from the "[sqlite_schema](schematab.html)" table so that it can know
...
[sqlite3_open()](c3ref/open.html) interface,
...
(such as [PRAGMA synchronous=OFF](pragma.html#pragma_synchronous) or [PRAGMA journal_mode=MEMORY](pragma.html#pragma_journal_mode)) then
...
[journal_mode](pragma.html#pragma_journal_mode) PRAGMA.
For example:
