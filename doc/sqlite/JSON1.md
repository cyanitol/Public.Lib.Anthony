...
2. [Compiling in JSON Support](#2-compiling-in-json-support)
3. [Interface Overview](#3-interface-overview)
   - 3.1. [JSON arguments](#31-json-arguments)
   - 3.2. [JSONB](#jsonb)
     - 3.2.1. [The JSONB format](#321-the-jsonb-format)
     - 3.2.2. [Handling of malformed JSONB](#322-handling-of-malformed-jsonb)
   - 3.3. [PATH arguments](#33-path-arguments)
   - 3.4. [VALUE arguments](#34-value-arguments)
   - 3.5. [Compatibility](#35-compatibility)
   - 3.6. [JSON5 Extensions](#36-json5-extensions)
   - 3.7. [Performance Considerations](#37-performance-considerations)
   - 3.8. [The JSON BLOB Input Bug](#38-the-json-blob-input-bug)
4. [Function Details](#4-function-details)
   - 4.1. [The json() function](#41-the-json-function)
   - 4.2. [The jsonb() function](#42-the-jsonb-function)
   - 4.3. [The json_array() function](#43-the-json_array-function)
   - 4.4. [The jsonb_array() function](#44-the-jsonb_array-function)
   - 4.5. [The json_array_length() function](#45-the-json_array_length-function)
   - 4.6. [The json_error_position() function](#46-the-json_error_position-function)
   - 4.7. [The json_extract() function](#47-the-json_extract-function)
   - 4.8. [The jsonb_extract() function](#48-the-jsonb_extract-function)
   - 4.9. [The -> and ->> operators](#49-the-and-operators)
   - 4.10. [The json_insert(), json_replace, and json_set() functions](#410-the-json_insert-json_replace-and-json_set-functions)
   - 4.11. [The jsonb_insert(), jsonb_replace, and jsonb_set() functions](#411-the-jsonb_insert-jsonb_replace-and-jsonb_set-functions)
   - 4.12. [The json_object() function](#412-the-json_object-function)
   - 4.13. [The jsonb_object() function](#413-the-jsonb_object-function)
   - 4.14. [The json_patch() function](#414-the-json_patch-function)
   - 4.15. [The jsonb_patch() function](#415-the-jsonb_patch-function)
   - 4.16. [The json_pretty() function](#416-the-json_pretty-function)
   - 4.17. [The json_remove() function](#417-the-json_remove-function)
   - 4.18. [The jsonb_remove() function](#418-the-jsonb_remove-function)
   - 4.19. [The json_type() function](#419-the-json_type-function)
   - 4.20. [The json_valid() function](#420-the-json_valid-function)
   - 4.21. [The json_quote() function](#421-the-json_quote-function)
   - 4.22. [Array and object aggregate functions](#422-array-and-object-aggregate-functions)
   - 4.23. [Table valued functions for parsing JSON: json_each(), jsonb_each(), json_tree(), and jsonb_tree()](#423-table-valued-functions-for-parsing-json-json_each-jsonb_each-json_tree-and-jsonb_tree)
     - 4.23.1. [Examples using json_each() and json_tree()](#4231-examples-using-json_each-and-json_tree)

## 1. Overview

By default, SQLite supports thirty functions and two operators for dealing with JSON values. There are also four table-valued functions that can be used to decompose a JSON string. All of the functions listed below have the SQLITE_INNOCUOUS and SQLITE_DETERMINISTIC flags.
...
19. jsonb_remove(json,path,...)
20. json_replace(json,path,value,...)
21. jsonb_replace(json,path,value,...)
22. json_set(json,path,value,...)
23. jsonb_set(json,path,value,...)
24. json_type(json)
    json_type(json,path)
25. json_valid(json)
...
27. json_group_array(value)
28. jsonb_group_array(value)
29. json_group_object(label,value)
30. jsonb_group_object(name,value)
...
| Supported since SQLite version... | 3.9.0 (2015-10-14) | 3.51.0 (2025-11-04) | 3.9.0 (2015-10-14) | 3.51.0 (2025-11-04) |
