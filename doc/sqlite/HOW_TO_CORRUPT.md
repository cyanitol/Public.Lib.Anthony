...
[2.3. Multiple copies of SQLite linked into the same application](#multiple_copies_of_sqlite_linked_into_the_same_application)
[2.4.  Two processes using different locking protocols](#_two_processes_using_different_locking_protocols)
[2.5.  Unlinking or renaming a database file while in use](#_unlinking_or_renaming_a_database_file_while_in_use)
[2.6.  Multiple links to the same file](#_multiple_links_to_the_same_file)
[2.7.  Carrying an open database connection across a fork() ](#_carrying_an_open_database_connection_across_a_fork_)
