...
Table Of Contents
[1. Datatypes In SQLite](#1-datatypes-in-sqlite)
[2. Storage Classes and Datatypes](#2-storage-classes-and-datatypes)
[2.1. Boolean Datatype](#21-boolean-datatype)
[2.2. Date and Time Datatype](#22-date-and-time-datatype)
[3. Type Affinity](#3-type-affinity)
[3.1. Determination Of Column Affinity](#31-determination-of-column-affinity)
[3.1.1. Affinity Name Examples](#311-affinity-name-examples)
[3.2. Affinity Of Expressions](#32-affinity-of-expressions)
[3.3. Column Affinity For Views And Subqueries](#33-column-affinity-for-views-and-subqueries)
[3.3.1. Column Affinity For Compound Views](#331-column-affinity-for-compound-views)
[3.4. Column Affinity Behavior Example](#34-column-affinity-behavior-example)
[4. Comparison Expressions](#4-comparison-expressions)
[4.1. Sort Order](#41-sort-order)
[4.2. Type Conversions Prior To Comparison](#42-type-conversions-prior-to-comparison)
[4.3. Comparison Example](#43-comparison-example)
[5. Operators](#5-operators)
[6. Sorting, Grouping and Compound SELECTs](#6-sorting-grouping-and-compound-selects)
[7. Collating Sequences](#7-collating-sequences)
[7.1. Assigning Collating Sequences from SQL](#71-assigning-collating-sequences-from-sql)
[7.2. Collation Sequence Examples](#72-collation-sequence-examples)
...
(other than the large global [SQLITE_MAX_LENGTH](limits.html#max_length) limit) on the length of
...
- **NOCASE** - Similar to binary, except that it uses
     [sqlite3_strnicmp()](c3ref/stricmp.html) for the comparison.  Hence the 26 upper case
