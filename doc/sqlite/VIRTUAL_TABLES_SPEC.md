...
[1.1. Usage](#11-usage)
[1.1.1. Temporary virtual tables](#111-temporary-virtual-tables)
[1.1.2. Eponymous virtual tables](#112-eponymous-virtual-tables)
[1.1.3. Eponymous-only virtual tables](#113-eponymous-only-virtual-tables)
[1.2. Implementation](#12-implementation)
[1.3. Virtual Tables And Shared Cache](#13-virtual-tables-and-shared-cache)
[1.4. Creating New Virtual Table Implementations](#14-creating-new-virtual-table-implementations)
[2. Virtual Table Methods](#2-virtual-table-methods)
[2.1. The xCreate Method](#21-the-xcreate-method)
[2.1.1. Hidden columns in virtual tables](#211-hidden-columns-in-virtual-tables)
[2.1.2. Table-valued functions](#212-table-valued-functions)
[2.1.3.  WITHOUT ROWID Virtual Tables ](#213-without-rowid-virtual-tables)
[2.2. The xConnect Method](#22-the-xconnect-method)
[2.3. The xBestIndex Method](#23-the-xbestindex-method)
[2.3.1. Inputs](#231-inputs)
[2.3.1.1. LIKE, GLOB, REGEXP, and MATCH functions](#2311-like-glob-regexp-and-match-functions)
[2.3.1.2. LIMIT and OFFSET](#2312-limit-and-offset)
[2.3.1.3. Right-hand side values of constraints](#2313-right-hand-side-values-of-constraints)
[2.3.2. Outputs](#232-outputs)
[2.3.2.1. Omit constraint checking in bytecode](#2321-omit-constraint-checking-in-bytecode)
[2.3.2.2. ORDER BY and orderByConsumed](#2322-order-by-and-orderbyconsumed)
[2.3.3. Return Value](#233-return-value)
[2.3.4. Enforcing Required Parameters On Table-Valued Functions](#234-enforcing-required-parameters-on-table-valued-functions)
[2.4. The xDisconnect Method](#24-the-xdisconnect-method)
[2.5. The xDestroy Method](#25-the-xdestroy-method)
[2.6. The xOpen Method](#26-the-xopen-method)
[2.7. The xClose Method](#27-the-xclose-method)
[2.8. The xEof Method](#28-the-xeof-method)
[2.9. The xFilter Method](#29-the-xfilter-method)
[2.10. The xNext Method](#210-the-xnext-method)
[2.11. The xColumn Method](#211-the-xcolumn-method)
[2.12. The xRowid Method](#212-the-xrowid-method)
[2.13. The xUpdate Method](#213-the-xupdate-method)
[2.14. The xFindFunction Method](#214-the-xfindfunction-method)
[2.15. The xBegin Method](#215-the-xbegin-method)
[2.16. The xSync Method](#216-the-xsync-method)
[2.17. The xCommit Method](#217-the-xcommit-method)
[2.18. The xRollback Method](#218-the-xrollback-method)
[2.19. The xRename Method](#219-the-xrename-method)
[2.20. The xSavepoint, xRelease, and xRollbackTo Methods](#220-the-xsavepoint-xrelease-and-xrollbackto-methods)
[2.21. The xShadowName Method](#221-the-xshadowname-method)
[2.22. The xIntegrity Method](#222-the-xintegrity-method)
...
the [sqlite3_create_module()](c3ref/create_module.html) interface.
...
must be compiled with the [SQLITE_ENABLE_DBSTAT_VTAB](compile.html#enable_dbstat_vtab) option to include
...
The [sqlite3_module](c3ref/module.html) structure defines a module object used to implement
...
Each virtual table instance is represented by an [sqlite3_vtab](c3ref/vtab.html) structure. 
...
SQLite memory allocation function such as [sqlite3_mprintf()](c3ref/mprintf.html) or
...
[sqlite3_free()](c3ref/free.html). Failure to do this will result in a memory leak. 
...
The [sqlite3_vtab_cursor](c3ref/vtab_cursor.html) structure represents a pointer to a specific
...
The [sqlite3_index_info](c3ref/index_info.html) structure is used to pass information into
...
connection. This is accomplished using either of the [sqlite3_create_module()](c3ref/create_module.html)
...
The [sqlite3_create_module()](c3ref/create_module.html) and [sqlite3_create_module_v2()](c3ref/create_module.html)
routines associate a module name with an [sqlite3_module](c3ref/module.html) 
...
The [sqlite3_create_module()](c3ref/create_module.html) interface would return an error if 
...
-  Create an instance of the [sqlite3_module](c3ref/module.html) structure containing pointers
     to all the methods from step 1.

-  Register your [sqlite3_module](c3ref/module.html) structure using one of the
     [sqlite3_create_module()](c3ref/create_module.html) or [sqlite3_create_module_v2()](c3ref/create_module.html) interfaces.

-  Run a [CREATE VIRTUAL TABLE](lang_createvtab.html) command that specifies the new module in 
     the USING clause. 
...
Contains the sources for the [json_each()](json1.html#jeach) and [json_tree()](json1.html#jtree) table-valued
functions.
...
fourth argument to the [sqlite3_create_module()](c3ref/create_module.html) or
[sqlite3_create_module_v2()](c3ref/create_module.html) call that registered the 
...
[sqlite3_create_module()](c3ref/create_module.html) and as the argument to the USING clause of the
...
(an [sqlite3_vtab](c3ref/vtab.html) object) and return a pointer to it in *ppVTab.

As part of the task of creating a new [sqlite3_vtab](c3ref/vtab.html) structure, this 
method must invoke [sqlite3_declare_vtab()](c3ref/declare_vtab.html) to tell the SQLite 
core about the columns and datatypes in the virtual table. 
The [sqlite3_declare_vtab()](c3ref/declare_vtab.html) API has the following prototype:
...
The first argument to [sqlite3_declare_vtab()](c3ref/declare_vtab.html) must be the same 
[database connection](c3ref/sqlite3.html) pointer as the first parameter to this method.
The second argument to [sqlite3_declare_vtab()](c3ref/declare_vtab.html) must a zero-terminated 
...
deallocated and/or reused as soon as the [sqlite3_declare_vtab()](c3ref/declare_vtab.html)
routine returns.

The xConnect method can also optionally request special features
for the virtual table by making one or more calls to
the [sqlite3_vtab_config()](c3ref/vtab_config.html) interface:
...
invoke "[sqlite3_vtab_config](c3ref/vtab_config.html)(db, [SQLITE_VTAB_DIRECTONLY](c3ref/c_vtab_constraint_support.html#sqlitevtabdirectonly))" if the
...
fields of the [sqlite3_vtab](c3ref/vtab.html) object.  The SQLite core will take care of 
that chore.

The xCreate should return [SQLITE_OK](rescode.html#ok) if it is successful in 
creating the new virtual table, or [SQLITE_ERROR](rescode.html#error) if it is not successful.
If not successful, the [sqlite3_vtab](c3ref/vtab.html) structure must not be allocated. 
...
[sqlite3_malloc()](c3ref/free.html) or [sqlite3_mprintf()](c3ref/mprintf.html) as the SQLite core will
attempt to free the space using [sqlite3_free()](c3ref/free.html) after the error has
...
For example, if the following SQL is passed to [sqlite3_declare_vtab()](c3ref/declare_vtab.html):
...
[ext/misc/series.c](https://sqlite.org/src/artifact?ci=trunk&filename=ext/misc/series.c)
file in the [source tree](https://sqlite.org/src/tree?ci=trunk))
...
The [sqlite3_module.xBestIndex](vtab.html#xbestindex) method in the implementation of this
...
is passed into [sqlite3_declare_vtab()](c3ref/declare_vtab.html) may contain a [WITHOUT ROWID](withoutrowid.html) clause.
...
It has the same parameters and constructs a new [sqlite3_vtab](c3ref/vtab.html) structure 
just like xCreate. 
And it must also call [sqlite3_declare_vtab()](c3ref/declare_vtab.html) like xCreate.  It
should also make all of the same [sqlite3_vtab_config()](c3ref/vtab_config.html) calls as
xCreate.
...
The xConnect method must return [SQLITE_OK](rescode.html#ok) if it is successful 
in creating the new virtual table, or [SQLITE_ERROR](rescode.html#error) if it is not 
successful. If not successful, the [sqlite3_vtab](c3ref/vtab.html) structure must not be 
...
though the [xCreate](vtab.html#xcreate) and xConnect pointers of the [sqlite3_module](c3ref/module.html) object
...
in certain fields of the [sqlite3_index_info](c3ref/index_info.html) structure and passing a 
...
forms the reply. The [sqlite3_index_info](c3ref/index_info.html) structure looks like this:
...
version - perhaps comparing the value returned from [sqlite3_libversion_number()](c3ref/libversion.html)
...
Use the [sqlite3_vtab_collation()](c3ref/vtab_collation.html) interface to find the name of
...
when it is running [sqlite3_prepare()](c3ref/prepare.html) or the equivalent. 
...
xBestIndex multiple times with different settings in [sqlite3_index_info](c3ref/index_info.html).
...
of the [sqlite3_index_info](c3ref/index_info.html) structure with information about the
...
The information in the [sqlite3_index_info](c3ref/index_info.html) structure is ephemeral
...
[sqlite3_index_info](c3ref/index_info.html) structure, it should make a copy.  Care must be
...
[sqlite3_declare_vtab()](c3ref/declare_vtab.html) in the [xCreate](vtab.html#xcreate) or [xConnect](vtab.html#xconnect) method.
Hidden columns are counted when determining the column index.

If the [xFindFunction()](vtab.html#xfindfunction) method for the virtual table is defined, and 
if xFindFunction() sometimes returns [SQLITE_INDEX_CONSTRAINT_FUNCTION](c3ref/c_index_constraint_eq.html) or
...
The [sqlite3_vtab_rhs_value()](c3ref/vtab_rhs_value.html) interface can be used to try to
...
[SQLITE_INDEX_CONSTRAINT_ISNULL](c3ref/c_index_constraint_eq.html) and
[SQLITE_INDEX_CONSTRAINT_ISNOTNULL](c3ref/c_index_constraint_eq.html) have no right-hand operand.
The sqlite3_vtab_rhs_value() interface always returns
[SQLITE_NOTFOUND](rescode.html#notfound) for such operators.
...
memory allocation function such as [sqlite3_mprintf()](c3ref/mprintf.html). 
If this is the case, then the needToFreeIdxStr flag must be set to 
true so that the SQLite core will know to call [sqlite3_free()](c3ref/free.html) on 
...
[sqlite3_index_info](c3ref/index_info.html) structure. 
...
By default, the SQLite generates [bytecode](opcode.html) that will double-check
...
The omit flag is always honored for [SQLITE_INDEX_CONSTRAINT_OFFSET](c3ref/c_index_constraint_eq.html)
...
[sqlite3_vtab_distinct()](c3ref/vtab_distinct.html) interface returns 1 or 2, that indicates
...
kind of fatal error occurs, an appropriate error code (ex: [SQLITE_NOMEM](rescode.html#nomem))
should be returned instead.

If xBestIndex returns [SQLITE_CONSTRAINT](rescode.html#constraint), that does not indicate an
...
to be safely used, and the [sqlite3_prepare()](c3ref/prepare.html) call will fail with
...
false -> return SQLITE_CONSTRAINT.
...
Only the [sqlite3_vtab](c3ref/vtab.html) object is destroyed.
...
will allocate the memory for the [sqlite3_vtab_cursor](c3ref/vtab_cursor.html) (or a subclass),
initialize the new object, and make *ppCursor point to the new object.
The successful call then returns [SQLITE_OK](rescode.html#ok).
...
[sqlite3_vtab_cursor](c3ref/vtab_cursor.html) structure.  The SQLite core will take care
...
[sqlite3_vtab_cursor](c3ref/vtab_cursor.html) again after it has been closed.
...
of the [sqlite3_index_info](c3ref/index_info.html) structure. 
...
This method must return [SQLITE_OK](rescode.html#ok) if successful, or an sqlite 
...
[error code](rescode.html).  The xColumn method must return [SQLITE_OK](rescode.html#ok) on success.
...
This method returns [SQLITE_OK](rescode.html#ok) on success.
...
using the [sqlite3_declare_vtab()](c3ref/declare_vtab.html) call.  All hidden columns are included.
...
this will become the value returned by the [sqlite3_last_insert_rowid()](c3ref/last_insert_rowid.html)
...
The xUpdate method must return [SQLITE_OK](rescode.html#ok) if and only if it is
...
using functions such as [sqlite3_mprintf()](c3ref/mprintf.html) or [sqlite3_malloc()](c3ref/free.html).
...
[sqlite3_value_nochange(X)](c3ref/value_blob.html) can be used to discover which columns
of the virtual table were actually modified by the UPDATE
statement.  The [sqlite3_value_nochange(X)](c3ref/value_blob.html) interface returns
...
by invoking [sqlite3_vtab_nochange()](c3ref/vtab_nochange.html).  If [xColumn](vtab.html#xcolumn) sees that
the column is not being modified, it should return without setting 
a result using one of the [sqlite3_result_xxxxx()](c3ref/result_blob.html)
interfaces.  Only in that case [sqlite3_value_nochange()](c3ref/value_blob.html) will be
true within the xUpdate method.  If [xColumn](vtab.html#xcolumn) does
invoke one or more [sqlite3_result_xxxxx()](c3ref/result_blob.html)
interfaces, then SQLite understands that as a change in the value
of the column and the [sqlite3_value_nochange()](c3ref/value_blob.html) call for that
column within xUpdate will return false.

There might be one or more [sqlite3_vtab_cursor](c3ref/vtab_cursor.html) objects open and in use 
...
If the xUpdate pointer in the [sqlite3_module](c3ref/module.html) for a virtual table
...
This method is called during [sqlite3_prepare()](c3ref/prepare.html) to give the virtual
...
[SQLITE_INDEX_CONSTRAINT_FUNCTION](c3ref/c_index_constraint_eq.html) and 255.
...
[SQLITE_INDEX_CONSTRAINT_FUNCTION](c3ref/c_index_constraint_eq.html) or greater was added in
version 3.25.0 (2018-09-15).  If xFindFunction returns
[SQLITE_INDEX_CONSTRAINT_FUNCTION](c3ref/c_index_constraint_eq.html) or greater, than means that the function
...
result.  When xFindFunction returns [SQLITE_INDEX_CONSTRAINT_FUNCTION](c3ref/c_index_constraint_eq.html) or 
larger, the value returned becomes the [sqlite3_index_info](c3ref/index_info.html).aConstraint.op
...
of [SQLITE_INDEX_CONSTRAINT_FUNCTION](c3ref/c_index_constraint_eq.html) to improve performance.
The xFindFunction() method for Geopoly returns
SQLITE_INDEX_CONSTRAINT_FUNCTION for the [geopoly_overlap()](geopoly.html#goverlap) SQL function
and it returns
SQLITE_INDEX_CONSTRAINT_FUNCTION+1 for the [geopoly_within()](geopoly.html#gwithin) SQL function.
...
the lifetime of the [sqlite3_vtab](c3ref/vtab.html) object given in the first parameter.
...
This method is optional.  The xBegin pointer of [sqlite3_module](c3ref/module.html)
may be NULL.
...
table.
This method is optional.  The xSync pointer of [sqlite3_module](c3ref/module.html)
may be NULL.

This method is only invoked after a call to the [xBegin](vtab.html#xBegin) method and
...
This method is optional.  The xCommit pointer of [sqlite3_module](c3ref/module.html)
may be NULL.
...
This method is optional.  The xRollback pointer of [sqlite3_module](c3ref/module.html)
may be NULL.
...
If this method returns [SQLITE_OK](rescode.html#ok) then SQLite renames the table.
...
The [PRAGMA legacy_alter_table](pragma.html#pragma_legacy_alter_table) setting is enabled prior to invoking this
...
and "%_docsize" where "%" is the name of the original virtual table.  These
...
[SQLITE_DBCONFIG_DEFENSIVE](c3ref/c_dbconfig_defensive.html#sqlitedbconfigdefensive) flag is set, then the shadow table is read-only
...
with corrupted shadow table content.  However, bugs in a particular virtual 
...
Shadow tables only become read-only when the [SQLITE_DBCONFIG_DEFENSIVE](c3ref/c_dbconfig_defensive.html#sqlitedbconfigdefensive)
flag is set using [sqlite3_db_config()](c3ref/db_config.html).
...
method is not NULL, then the [PRAGMA integrity_check](pragma.html#pragma_integrity_check) and
[PRAGMA quick_check](pragma.html#pragma_quick_check) commands will invoke
...
xIntegrity method allows the [PRAGMA integrity_check](pragma.html#pragma_integrity_check) command to verify
the integrity of content stored in a virtual table.

The xIntegrity method is called with five parameters:

- **pVTab** -> A pointer to the [sqlite3_vtab](c3ref/vtab.html) object that is the
...
- **mFlags** -> A flag to indicate whether this is an "integrity_check"
...
space to hold the error message string should be obtained from [sqlite3_malloc64()](c3ref/free.html)
...
[sqlite3_free()](c3ref/free.html) is invoked to reclaim the memory when it has finished
...
if the xIntegrity method was called due to [PRAGMA integrity_check](pragma.html#pragma_integrity_check) (mFlags==0)
or due to [PRAGMA quick_check](pragma.html#pragma_quick_check) (mFlags==1).  Generally speaking, the xIntegrity
...
when [PRAGMA integrity_check](pragma.html#pragma_integrity_check) is run.
