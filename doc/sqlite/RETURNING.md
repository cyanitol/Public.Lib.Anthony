...
of [sqlite3_step()](c3ref/step.html).  The RETURNING clause output is accumulated in
...
Even if SQLite is compiled with the [SQLITE_ENABLE_UPDATE_DELETE_LIMIT](compile.html#enable_update_delete_limit)
...
The RETURNING clause may not contain top-level [aggregate functions](lang_aggfunc.html) or
